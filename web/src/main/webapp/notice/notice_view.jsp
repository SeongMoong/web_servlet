...
<body>
<span class="n">등록일 : <div class="data1"><%=views.get(8).substring(0,10) %></div></span><br>
...
<span class="n">첨부파일 : <div class="data1"><a href="../notice_file/<%=views.get(6)%>" target="_blank"><%=views.get(6)%></a></div></span>
