...
<p>회원가입 약관</p>
<!-- id는 똑같은 이름을 사용할 수 없음 -->
<!-- 전달할 값이 없기때문에 name값 불필요 -->
<input type ="checkbox" id="all" onclick ="all_check(this.checked)"> 전체선택<br>
<input type ="checkbox" name="agree" value="Y0" onclick="ag_check()">서비스 이용약관 동의(필수)<br><!-- value값 없으면 null값 날라감 -->
...
//하나라도 false 일 경우 전체선택을 해제 또는 모두 체크가 되었을 경우 전체선택이 선택됨
