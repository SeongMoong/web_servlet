...
public class login extends HttpServlet {
	...
	//doGet, doPost : Front-end 가 Form태그에 method를 설정한 사항과 동일한 정보를 처리하는 메소드
	//request : Front-end에게 전달 받는 값
	//response : Back-end가 처리한 결과값을 출력하는 역할
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("utf-8"); //Front의 한글일 경우 한글깨짐 방지
		response.setCharacterEncoding("utf-8");//결과 내용을 한글 깨짐없이 사용하는 언어셋 셋팅
